$(function () {
  ...
  $("#pb-calendar").pb_calendar({
    schedule_list: function (callback_, yyyymm_) {
      ...
      temp_schedule_list_[current_yyyymm_ + "05"] = [{ ID: 1, style: "red" }];

      temp_schedule_list_[current_yyyymm_ + "15"] = [{ ID: 2, style: "red" }];

      temp_schedule_list_[current_yyyymm_ + "20"] = [{ ID: 5, style: "green" }];
      temp_schedule_list_[current_yyyymm_ + "22"] = [{ ID: 5, style: "green" }];
